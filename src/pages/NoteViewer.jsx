    ...
    <div className="mx-2 my-4">
      <div className="m-2 flex gap-2 items-center">
        ...
        <Link to={`/create-note/${id}`}
          className="bg-white border-4 border-black px-4 py-1 shadow-[3px_3px_0px_rgba(0,0,0,1)] hover:bg-gray-100 cursor-pointer transition"
        >
          Edit
        </Link>
        <button className="bg-white border-4 border-black px-4 py-1 shadow-[3px_3px_0px_rgba(0,0,0,1)] hover:bg-gray-100 cursor-pointer transition" onClick={()=>handleDelete(id)}>
          Delete
        </button>
      </div>
